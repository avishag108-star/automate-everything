...
![CI](https://github.com/avishag108-star/automate-everything/actions/workflows/ci.yml/badge.svg)
...
> ⚠️ Default credentials are `admin / changeme` — **change the password before deploying to production!**
Dashboards include:
