...
[![CI](https://github.com/avishag108-star/automate-everything/actions/workflows/ci.yml/badge.svg)](https://github.com/avishag108-star/automate-everything/actions/workflows/ci.yml)
...
\```bash
git clone https://github.com/avishag108-star/automate-everything
...
kubectl apply -f ~/automate-everything/gitops/argocd/application.yaml
\```
...
> ⚠️ Default credentials are `admin / changeme` — **change before deploying to production!**
...
*Built by [Avishag Tzruya](https://www.linkedin.com/in/avishag-tzruya-ba93983a2/)*
